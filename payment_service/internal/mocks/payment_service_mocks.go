...
//
//	mockgen -source=internal/handler/handler.go -destination=internal/mocks/payment_service_mocks.go -package=mocks
//
...
// GetTutorAnalytics mocks base method.
func (m *MockPaymentService) GetTutorAnalytics(ctx context.Context, input *models.GetTutorAnalyticsInput) (*models.TutorAnalytics, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTutorAnalytics", ctx, input)
	ret0, _ := ret[0].(*models.TutorAnalytics)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTutorAnalytics indicates an expected call of GetTutorAnalytics.
func (mr *MockPaymentServiceMockRecorder) GetTutorAnalytics(ctx, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTutorAnalytics", reflect.TypeOf((*MockPaymentService)(nil).GetTutorAnalytics), ctx, input)
}
