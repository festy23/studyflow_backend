...
// Source: internal/clients/scheduleServiceClient.go
//
// Generated by this command:
//
//	mockgen -source=internal/clients/scheduleServiceClient.go -destination=internal/mocks/schedule_serice_mock.go -package=mocks
//
...
func (m *MockScheduleServiceClient) ListCompletedUnpaidLessons(ctx context.Context, req *pkg.ListCompletedUnpaidLessonsRequest, opts ...grpc.CallOption) (*pkg.ListLessonsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, req}
	for _, a := range opts {
		varargs = append(varargs, a)
