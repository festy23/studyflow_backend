...
type CleanupOrphanUploadsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *CleanupOrphanUploadsRequest) Reset() {
	*x = CleanupOrphanUploadsRequest{}
	mi := &file_file_service_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CleanupOrphanUploadsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CleanupOrphanUploadsRequest) ProtoMessage() {}

func (x *CleanupOrphanUploadsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_file_service_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CleanupOrphanUploadsRequest.ProtoReflect.Descriptor instead.
func (*CleanupOrphanUploadsRequest) Descriptor() ([]byte, []int) {
	return file_file_service_proto_rawDescGZIP(), []int{6}
}

func (x *CleanupOrphanUploadsRequest) GetOlderThan() *timestamppb.Timestamp {
	if x != nil {
		return x.OlderThan
	}
	return nil
...
type CleanupOrphanUploadsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *CleanupOrphanUploadsResponse) Reset() {
	*x = CleanupOrphanUploadsResponse{}
	mi := &file_file_service_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CleanupOrphanUploadsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CleanupOrphanUploadsResponse) ProtoMessage() {}

func (x *CleanupOrphanUploadsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_file_service_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CleanupOrphanUploadsResponse.ProtoReflect.Descriptor instead.
func (*CleanupOrphanUploadsResponse) Descriptor() ([]byte, []int) {
	return file_file_service_proto_rawDescGZIP(), []int{7}
}

func (x *CleanupOrphanUploadsResponse) GetDeletedCount() int32 {
	if x != nil {
...
type File struct {
	...
	IsUploaded    bool                   `protobuf:"varint,6,opt,name=is_uploaded,json=isUploaded,proto3" json:"is_uploaded,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *File) GetIsUploaded() bool {
	if x != nil {
		return x.IsUploaded
	}
	return false
...
const file_file_service_proto_rawDesc = "" +
	...
	"\x1bCleanupOrphanUploadsRequest\x129\n" +
	"\n" +
	"older_than\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tolderThan\"C\n" +
	"\x1cCleanupOrphanUploadsResponse\x12#\n" +
	"\rdeleted_count\x18\x01 \x01(\x05R\fdeletedCount\"\xdf\x01\n" +
	"\x04File\x12\x0e\n" +
	...
	"\vGetFileMeta\x12\x1b.file.v1.GetFileMetaRequest\x1a\r.file.v1.File\x12=\n" +
	"\rConfirmUpload\x12\x1d.file.v1.ConfirmUploadRequest\x1a\r.file.v1.File\x12c\n" +
	"\x14CleanupOrphanUploads\x12$.file.v1.CleanupOrphanUploadsRequest\x1a%.file.v1.CleanupOrphanUploadsResponseB\tZ\apkg/apib\x06proto3"
...
var file_file_service_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_file_service_proto_goTypes = []any{
	...
	(*CleanupOrphanUploadsRequest)(nil),  // 6: file.v1.CleanupOrphanUploadsRequest
	(*CleanupOrphanUploadsResponse)(nil), // 7: file.v1.CleanupOrphanUploadsResponse
	(*File)(nil),                         // 8: file.v1.File
	(*timestamppb.Timestamp)(nil),        // 9: google.protobuf.Timestamp
}
var file_file_service_proto_depIdxs = []int32{
	9, // 0: file.v1.CleanupOrphanUploadsRequest.older_than:type_name -> google.protobuf.Timestamp
	9, // 1: file.v1.File.created_at:type_name -> google.protobuf.Timestamp
	0, // 2: file.v1.FileService.InitUpload:input_type -> file.v1.InitUploadRequest
	2, // 3: file.v1.FileService.GenerateDownloadURL:input_type -> file.v1.GenerateDownloadURLRequest
	4, // 4: file.v1.FileService.GetFileMeta:input_type -> file.v1.GetFileMetaRequest
	5, // 5: file.v1.FileService.ConfirmUpload:input_type -> file.v1.ConfirmUploadRequest
	6, // 6: file.v1.FileService.CleanupOrphanUploads:input_type -> file.v1.CleanupOrphanUploadsRequest
	1, // 7: file.v1.FileService.InitUpload:output_type -> file.v1.InitUploadResponse
	3, // 8: file.v1.FileService.GenerateDownloadURL:output_type -> file.v1.DownloadURL
	8, // 9: file.v1.FileService.GetFileMeta:output_type -> file.v1.File
	8, // 10: file.v1.FileService.ConfirmUpload:output_type -> file.v1.File
	7, // 11: file.v1.FileService.CleanupOrphanUploads:output_type -> file.v1.CleanupOrphanUploadsResponse
...
func file_file_service_proto_init() {
	...
	file_file_service_proto_msgTypes[8].OneofWrappers = []any{}
	type x struct{}
