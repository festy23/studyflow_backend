...
const (
	...
	FileService_CleanupOrphanUploads_FullMethodName = "/file.v1.FileService/CleanupOrphanUploads"
)
...
type FileServiceClient interface {
	...
	ConfirmUpload(ctx context.Context, in *ConfirmUploadRequest, opts ...grpc.CallOption) (*File, error)
	// Internal cleanup: удалить неподтвержденные загрузки старше cutoff
	CleanupOrphanUploads(ctx context.Context, in *CleanupOrphanUploadsRequest, opts ...grpc.CallOption) (*CleanupOrphanUploadsResponse, error)
}
...
func (c *fileServiceClient) ConfirmUpload(ctx context.Context, in *ConfirmUploadRequest, opts ...grpc.CallOption) (*File, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(File)
...
func (c *fileServiceClient) CleanupOrphanUploads(ctx context.Context, in *CleanupOrphanUploadsRequest, opts ...grpc.CallOption) (*CleanupOrphanUploadsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CleanupOrphanUploadsResponse)
	err := c.cc.Invoke(ctx, FileService_CleanupOrphanUploads_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileServiceServer interface {
	...
	// Подтверждение, что клиент завершил загрузку по signed URL
	ConfirmUpload(context.Context, *ConfirmUploadRequest) (*File, error)
	// Internal cleanup: удалить неподтвержденные загрузки старше cutoff
	CleanupOrphanUploads(context.Context, *CleanupOrphanUploadsRequest) (*CleanupOrphanUploadsResponse, error)
...
func (UnimplementedFileServiceServer) ConfirmUpload(context.Context, *ConfirmUploadRequest) (*File, error) {
	return nil, status.Error(codes.Unimplemented, "method ConfirmUpload not implemented")
}
func (UnimplementedFileServiceServer) CleanupOrphanUploads(context.Context, *CleanupOrphanUploadsRequest) (*CleanupOrphanUploadsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CleanupOrphanUploads not implemented")
}
...
func _FileService_CleanupOrphanUploads_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CleanupOrphanUploadsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileServiceServer).CleanupOrphanUploads(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_CleanupOrphanUploads_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).CleanupOrphanUploads(ctx, req.(*CleanupOrphanUploadsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CleanupOrphanUploads",
			Handler:    _FileService_CleanupOrphanUploads_Handler,
		},
	},
