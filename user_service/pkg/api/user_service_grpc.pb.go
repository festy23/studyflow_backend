...
func (c *userServiceClient) GetTelegramChatId(ctx context.Context, in *GetTelegramChatIdRequest, opts ...grpc.CallOption) (*GetTelegramChatIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_GetTelegramChatId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) RegisterViaTelegram(context.Context, *RegisterViaTelegramRequest) (*User, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterViaTelegram not implemented")
}
func (UnimplementedUserServiceServer) AuthorizeByAuthHeader(context.Context, *AuthorizeByAuthHeaderRequest) (*User, error) {
	return nil, status.Error(codes.Unimplemented, "method AuthorizeByAuthHeader not implemented")
}
...
func (UnimplementedUserServiceServer) ListTutorStudents(context.Context, *ListTutorStudentsRequest) (*ListTutorStudentsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListTutorStudents not implemented")
}
func (UnimplementedUserServiceServer) ListTutorsForStudent(context.Context, *ListTutorsForStudentRequest) (*ListTutorsForStudentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListTutorsForStudent not implemented")
}
func (UnimplementedUserServiceServer) ResolveTutorStudentContext(context.Context, *ResolveTutorStudentContextRequest) (*ResolvedTutorStudentContext, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolveTutorStudentContext not implemented")
}
...
func _UserService_GetTelegramChatId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(UserServiceServer).GetTelegramChatId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetTelegramChatId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetTelegramChatId(ctx, req.(*GetTelegramChatIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_GetTelegramChatId_Handler,
		},
	},
