...
type GetTelegramChatIdRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetTelegramChatIdRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type GetTelegramChatIdResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TelegramId    int64                  `protobuf:"varint,1,opt,name=telegram_id,json=telegramId,proto3" json:"telegram_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetTelegramChatIdResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_user_service_proto_rawDesc = "" +
	...
	"\btutor_id\x18\x01 \x01(\tR\atutorId\"3\n" +
	"\x18GetTelegramChatIdRequest\x12\x17\n" +
	...
	"\x11_lesson_price_rubB\x19\n" +
	"\x17_lesson_connection_link2\xc2\n" +
	"\n" +
	"\vUserService\x12I\n" +
...
var file_user_service_proto_goTypes = []any{
	...
	(*Empty)(nil),                             // 20: user.v1.Empty
	(*User)(nil),                              // 21: user.v1.User
	(*UserPublic)(nil),                        // 22: user.v1.UserPublic
	(*TutorProfile)(nil),                      // 23: user.v1.TutorProfile
	(*TutorStudent)(nil),                      // 24: user.v1.TutorStudent
	(*timestamppb.Timestamp)(nil),             // 25: google.protobuf.Timestamp
}
var file_user_service_proto_depIdxs = []int32{
	24, // 0: user.v1.ListTutorStudentsResponse.students:type_name -> user.v1.TutorStudent
	24, // 1: user.v1.ListTutorsForStudentResponse.tutors:type_name -> user.v1.TutorStudent
	25, // 2: user.v1.User.created_at:type_name -> google.protobuf.Timestamp
	25, // 3: user.v1.User.edited_at:type_name -> google.protobuf.Timestamp
	25, // 4: user.v1.TutorProfile.created_at:type_name -> google.protobuf.Timestamp
	25, // 5: user.v1.TutorProfile.edited_at:type_name -> google.protobuf.Timestamp
	25, // 6: user.v1.TutorStudent.created_at:type_name -> google.protobuf.Timestamp
	25, // 7: user.v1.TutorStudent.edited_at:type_name -> google.protobuf.Timestamp
	...
	20, // 10: user.v1.UserService.GetMe:input_type -> user.v1.Empty
	...
	4,  // 13: user.v1.UserService.DeleteUser:input_type -> user.v1.DeleteUserRequest
	6,  // 14: user.v1.UserService.UpdateTutorProfile:input_type -> user.v1.UpdateTutorProfileRequest
	5,  // 15: user.v1.UserService.GetTutorProfileByUserId:input_type -> user.v1.GetTutorProfileByUserIdRequest
	7,  // 16: user.v1.UserService.GetTutorStudent:input_type -> user.v1.GetTutorStudentRequest
	8,  // 17: user.v1.UserService.CreateTutorStudent:input_type -> user.v1.CreateTutorStudentRequest
	9,  // 18: user.v1.UserService.UpdateTutorStudent:input_type -> user.v1.UpdateTutorStudentRequest
	10, // 19: user.v1.UserService.DeleteTutorStudent:input_type -> user.v1.DeleteTutorStudentRequest
	11, // 20: user.v1.UserService.ListTutorStudents:input_type -> user.v1.ListTutorStudentsRequest
	13, // 21: user.v1.UserService.ListTutorsForStudent:input_type -> user.v1.ListTutorsForStudentRequest
	15, // 22: user.v1.UserService.ResolveTutorStudentContext:input_type -> user.v1.ResolveTutorStudentContextRequest
	17, // 23: user.v1.UserService.AcceptInvitationFromTutor:input_type -> user.v1.AcceptInvitationFromTutorRequest
	18, // 24: user.v1.UserService.GetTelegramChatId:input_type -> user.v1.GetTelegramChatIdRequest
	21, // 25: user.v1.UserService.RegisterViaTelegram:output_type -> user.v1.User
	21, // 26: user.v1.UserService.AuthorizeByAuthHeader:output_type -> user.v1.User
	21, // 27: user.v1.UserService.GetMe:output_type -> user.v1.User
	22, // 28: user.v1.UserService.GetUser:output_type -> user.v1.UserPublic
	21, // 29: user.v1.UserService.UpdateUser:output_type -> user.v1.User
	21, // 30: user.v1.UserService.DeleteUser:output_type -> user.v1.User
	23, // 31: user.v1.UserService.UpdateTutorProfile:output_type -> user.v1.TutorProfile
	23, // 32: user.v1.UserService.GetTutorProfileByUserId:output_type -> user.v1.TutorProfile
	24, // 33: user.v1.UserService.GetTutorStudent:output_type -> user.v1.TutorStudent
	24, // 34: user.v1.UserService.CreateTutorStudent:output_type -> user.v1.TutorStudent
	24, // 35: user.v1.UserService.UpdateTutorStudent:output_type -> user.v1.TutorStudent
	20, // 36: user.v1.UserService.DeleteTutorStudent:output_type -> user.v1.Empty
	12, // 37: user.v1.UserService.ListTutorStudents:output_type -> user.v1.ListTutorStudentsResponse
	14, // 38: user.v1.UserService.ListTutorsForStudent:output_type -> user.v1.ListTutorsForStudentResponse
	16, // 39: user.v1.UserService.ResolveTutorStudentContext:output_type -> user.v1.ResolvedTutorStudentContext
	20, // 40: user.v1.UserService.AcceptInvitationFromTutor:output_type -> user.v1.Empty
	19, // 41: user.v1.UserService.GetTelegramChatId:output_type -> user.v1.GetTelegramChatIdResponse
...
func file_user_service_proto_init() {
	...
	file_user_service_proto_msgTypes[24].OneofWrappers = []any{}
	type x struct{}
