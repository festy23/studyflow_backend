...
type CreateFeedbackRequest struct {
	...
	FileId        *string                `protobuf:"bytes,2,opt,name=file_id,json=fileId,proto3,oneof" json:"file_id,omitempty"`
	Comment       *string                `protobuf:"bytes,3,opt,name=comment,proto3,oneof" json:"comment,omitempty"`
	Grade         *int32                 `protobuf:"varint,4,opt,name=grade,proto3,oneof" json:"grade,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateFeedbackRequest) GetGrade() int32 {
...
func (x *UpdateFeedbackRequest) GetGrade() int32 {
	if x != nil && x.Grade != nil {
		return *x.Grade
	}
	return 0
...
type Feedback struct {
	...
	Grade         *int32                 `protobuf:"varint,7,opt,name=grade,proto3,oneof" json:"grade,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Feedback) GetGrade() int32 {
	if x != nil && x.Grade != nil {
		return *x.Grade
	}
	return 0
...
const file_homework_service_proto_rawDesc = "" +
	"\n" +
	"\x16homework_service.proto\x12\vhomework.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\a\n" +
	"\x05Empty\">\n" +
	...
	"\vsubmissions\x18\x01 \x03(\v2\x17.homework.v1.SubmissionR\vsubmissions\"\xb6\x01\n" +
	"\x15CreateFeedbackRequest\x12#\n" +
	"\rsubmission_id\x18\x01 \x01(\tR\fsubmissionId\x12\x1c\n" +
	"\afile_id\x18\x02 \x01(\tH\x00R\x06fileId\x88\x01\x01\x12\x1d\n" +
	"\acomment\x18\x03 \x01(\tH\x01R\acomment\x88\x01\x01\x12\x19\n" +
	"\x05grade\x18\x04 \x01(\x05H\x02R\x05grade\x88\x01\x01B\n" +
	"\n" +
	"\b_file_idB\n" +
	"\n" +
	"\b_commentB\b\n" +
	...
	"\tedited_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\beditedAt\x12\x19\n" +
	"\x05grade\x18\a \x01(\x05H\x02R\x05grade\x88\x01\x01B\n" +
	"\n" +
	"\b_file_idB\n" +
	"\n" +
	"\b_commentB\b\n" +
...
func file_homework_service_proto_init() {
	...
	file_homework_service_proto_msgTypes[19].OneofWrappers = []any{}
	file_homework_service_proto_msgTypes[20].OneofWrappers = []any{}
	file_homework_service_proto_msgTypes[21].OneofWrappers = []any{}
	type x struct{}
